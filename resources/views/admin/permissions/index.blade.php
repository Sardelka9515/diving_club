...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    ...
    <div class="btn-toolbar mb-2 mb-md-0">
        <a href="{{ route('admin.permissions.create') }}" class="btn btn-sm btn-primary">
            <i class="bi bi-plus-circle"></i> 新增權限
        </a>
    </div>
</div>
        ...
        <div class="table-responsive">
            <table class="table table-striped table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <form action="{{ route('admin.permissions.destroy', $permission) }}" method="POST" class="d-inline">
                                @csrf
                                @method('DELETE')
                                <button type="submit" class="btn btn-sm btn-danger" onclick="return confirm('確定要刪除此權限嗎？')">
                    ...
                    @empty
                    <tr>
                        <td colspan="4" class="text-center">沒有找到權限</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
