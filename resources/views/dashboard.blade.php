                        ...
                        <div class="col-md-3 mb-4">
                            <div class="card bg-success text-white h-100">
                                <div class="card-body text-center">
                                    ...
                                    <h5>已確認活動</h5>
                                    <p class="h3">{{ Auth::user()->registrations()->where('status', 'approved')->count() }}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3 mb-4">
                            <div class="card bg-warning text-white h-100">
                                <div class="card-body text-center">
                                    ...
                                    <h5>待審核活動</h5>
                                    <p class="h3">{{ Auth::user()->registrations()->where('status', 'pending')->count() }}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3 mb-4">
                            <div class="card bg-info text-white h-100">
                                <div class="card-body text-center">
                                    ...
                                    <h5>最新公告</h5>
                                    <p class="h3">{{ App\Models\Announcement::where('is_published', true)->count() }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row mt-4">
                        <div class="col-md-6">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    @php
                                        $recentRegistrations = Auth::user()->registrations()
                                            ->with('activity')
                                            ->latest()
                                            ->take(5)
                                            ->get();
                                            ...
                                            @foreach($recentRegistrations as $registration)
                                                <div class="list-group-item d-flex justify-content-between align-items-center">
                                                    <div>
                                                        ...
                                                        <small class="text-muted">{{ $registration->activity->start_date->format('Y/m/d H:i') }}</small>
                                                    </div>
                                                    <span class="badge bg-{{ $registration->status == 'approved' ? 'success' : ($registration->status == 'pending' ? 'warning' : 'danger') }} rounded-pill">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    @if($latestAnnouncements->count() > 0)
                                        ...
                                        <div class="mt-3">
                                            <a href="{{ route('announcements.index') }}" class="btn btn-primary">查看全部</a>
                                        </div>
                                    @else
